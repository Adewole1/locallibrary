...
class Genre(models.Model):  # Model representing a book genre (e.g. Science Fiction, Non Fiction).
...
class Book(models.Model):   #Model representing a book (but not a specific copy of a book).
    ...
    class Meta:
        permissions = (("book_edit", "Edit Book fields"),)
...
class BookInstance(models.Model):   # Model representing a specific copy of a book (i.e. that can be borrowed from the library).
    ...
    imprint = models.CharField(max_length=200, help_text="Publisher information")
...
class Author(models.Model): #Model representing an author
    ...
    class Meta:
        ...
        permissions = (("author_edit", "Edit Author fields"),)
